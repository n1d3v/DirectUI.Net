...
{
    public class DuiHostControl : UserControl
    {
        ...
        private void CreateDuiWindow()
        {
            ...
            _duiWindow = new DuiWindow(
                Name ?? "DuiControl", 0, 0, Width, Height,
        ...
        {
            base.OnResize(e);
            if (_duiWindow != null && _duiWindow.Handle != IntPtr.Zero) { SetWindowPos(_duiWindow.Handle, IntPtr.Zero, 0, 0, Width, Height, 0x0004 | 0x0002); }
        }
